          ...
          <div key={i}>
            ...
            <div className="block w-full">
              <table className="w-full bg-gray-50 text-gray-700 border border-slate-300 py-3 mb-3 leading-tight">
                ...
                <tbody>
                  {lap.exercises.map(
                    (exercise: UsedExerciseArrayItem, i: number) => (
                      <tr key={i}>
                        <td className="py-1 pl-4">
                          {exercise.usedExercise.exercise.title}
                        </td>
                        <td className="text-center">
                          {exercise.usedExercise.reps +
                            " " +
                            (exercise.usedExercise.timed ? "sec." : "reps.")}
                        </td>
                      </tr>
                    )
                  )}
