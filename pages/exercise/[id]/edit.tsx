      ...
      <Auth>
        <form onSubmit={(e) => handleEditButton(e, data.id!)}>
          <h2 className="p-10 pl-0 text-xl">
            Edit exercise - {props.exercise.title}
          </h2>
          <div className="mb-4">
          ...
          <div className="mb-4">
            <label className="input-label" htmlFor="mediaURL">
              Link for image / video
            </label>
            <input
              className="input-text"
              onChange={handleInput}
              type="url"
              placeholder="Exercise image / vide URL"
              id="mediaURL"
              name="mediaURL"
              value={data.mediaURL ?? ""}
            />
          ...
          <div className="mb-4">
            <input
              ...
              id="mediaIsImage"
              name="mediaIsImage"
              defaultChecked={data.mediaIsImage ?? false}
            />
            <label
              className="inline-block ml-2 align-middle input-label"
              htmlFor="mediaIsImage"
            >
              Is media image?
            </label>
          </div>
