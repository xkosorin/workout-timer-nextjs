...
const LapRow: FC<Props> = (props: Props) => {
  ...
  return(
    <tr className="w-full border-b">
      ...
      <td className="text-center"><button className="border px-1 rounded-full text-red-600 bg-white border-red-800 text-lg leading-5 align-text-top" onClick={ _ => props.onDelete(props.id) }>&times;</button></td>
    </tr>
  );
}
